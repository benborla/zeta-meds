...
--
-- Table structure for table `brille24_tierprice`
--
...
--
-- Indexes for table `brille24_tierprice`
--
...
--
-- Indexes for table `sylius_invoicing_plugin_billing_data`
--
ALTER TABLE `sylius_invoicing_plugin_billing_data`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sylius_invoicing_plugin_invoice`
--
ALTER TABLE `sylius_invoicing_plugin_invoice`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UNIQ_3AA279BF5CDB2AEB` (`billing_data_id`),
  ADD KEY `IDX_3AA279BF551F0F81` (`order_number`);

--
-- Indexes for table `sylius_invoicing_plugin_line_item`
--
ALTER TABLE `sylius_invoicing_plugin_line_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_C91408292989F1FD` (`invoice_id`);

--
-- Indexes for table `sylius_invoicing_plugin_sequence`
--
ALTER TABLE `sylius_invoicing_plugin_sequence`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `sylius_invoicing_plugin_tax_item`
--
ALTER TABLE `sylius_invoicing_plugin_tax_item`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_2951C61C2989F1FD` (`invoice_id`);
...
--
-- AUTO_INCREMENT for table `sylius_invoicing_plugin_billing_data`
--
ALTER TABLE `sylius_invoicing_plugin_billing_data`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sylius_invoicing_plugin_line_item`
--
ALTER TABLE `sylius_invoicing_plugin_line_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sylius_invoicing_plugin_sequence`
--
ALTER TABLE `sylius_invoicing_plugin_sequence`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `sylius_invoicing_plugin_tax_item`
--
ALTER TABLE `sylius_invoicing_plugin_tax_item`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `sylius_invoicing_plugin_invoice`
--
ALTER TABLE `sylius_invoicing_plugin_invoice`
  ADD CONSTRAINT `FK_3AA279BF5CDB2AEB` FOREIGN KEY (`billing_data_id`) REFERENCES `sylius_invoicing_plugin_billing_data` (`id`);

--
-- Constraints for table `sylius_invoicing_plugin_line_item`
--
ALTER TABLE `sylius_invoicing_plugin_line_item`
  ADD CONSTRAINT `FK_C91408292989F1FD` FOREIGN KEY (`invoice_id`) REFERENCES `sylius_invoicing_plugin_invoice` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `sylius_invoicing_plugin_tax_item`
--
ALTER TABLE `sylius_invoicing_plugin_tax_item`
  ADD CONSTRAINT `FK_2951C61C2989F1FD` FOREIGN KEY (`invoice_id`) REFERENCES `sylius_invoicing_plugin_invoice` (`id`) ON DELETE CASCADE;
